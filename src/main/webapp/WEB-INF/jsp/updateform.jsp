<%-- 
    Document   : updateform
    Created on : Jun 22, 2020, 2:42:13 PM
    Author     : pkontekas
--%>
...
<html>
    ...
    <body>
        ...
        <div style="margin-top: 40px; background-image: url(img/library_01.jpeg)" class="bg-img">
            <div class="overlay main-expand">
                <div class="d-flex justify-content-center align-items-center container">
                    <div class="col-lg-8 col-md-12 col-xs-12">
                        <div class="row">
                            <springform:form cssClass="font-weight-bold form-format main-form formcontainer needs-validation" action="doupdatetrainer" method="post"
                                             modelAttribute="trainertoupdate" novalidate="true">
                                <h3 class="h3">Trainer Update Form</h3><br>
                                ...
                                <button class="btn btn-outline-success text-dark font-weight-bold"
                                        onclick="return updated()" type="submit">Update</button>
                            </springform:form>
                        </div>
